                ...
                <div>
                    <Form {...form}>
                        <form 
                            ...
                            className="transition-all shadow-md rounded-lg border-none w-full p-4 px-3 md:px-6 focus-within:shadow-lg focus-within:-translate-y-1 focus-within:shadow-[#E5C0A8] shadow-[#E5C0A8] grid grid-cols-12 gap-2 dark:focus-within:shadow-[#113FAE] dark:shadow-[#113FAE]"
                        >
                            <FormField 
                                name="prompt" 
                                render={({ field }) => (
                                    <FormItem className="col-span-12 lg:col-span-10">
                                        <FormControl className="m-0 p-0">
                                            <Input 
                                                ...
                                                disabled={isLoading}
                                                placeholder="a modal using React hooks and Tailwind CSS"
                                                {...field}
                                            />
                                        </FormControl>
                                    </FormItem>
